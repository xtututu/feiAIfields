...
basekit.addField({
  ...
  execute: async (formItemParams: { videoMethod: any, videoPrompt: string, refImage: any,seconds:any,size:any }, context) => {
    const { videoPrompt = '', refImage = '' } = formItemParams;
    ...
    try {
      ...
      const jsonRequestOptions = {
          method: 'POST',
          headers: {'Content-Type': 'application/json',"Authorization": "Bearer sk-zH4De7x4cGPRH2v3po9L05N71cgDgF6Pb3HpkSPfLl4CJ4wo"},
